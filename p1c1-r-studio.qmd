...
1. Open RStudio and choose ‘tools’ from the toolbar
...
c. **Source on Save**- Automatically sources your file every time you hit save. "Sourcing" is similar to "Running" in the sense that both will execute your code; however, sourcing will execute your saved file rather than copying lines of code into the console.
...
p. **Row Numbers**- Display the row number for each line of your code on the left side of the document.
