...
This chapter will walk you through executing code and writing scripts in R. You will then build upon that knowledge by learning about comments, variables, operators, functions, loops, conditionals, and libraries. While this chapter is titled "Programming Basics", the knowledge you will have learned by the end of this chapter is enough for you to accomplish a huge variety of tasks.
...
Packages allow you to access functions other people have created and shared in
a standard format, e.g. via the 
[Comprehensive R Archive Network (CRAN)](https://cran.r-project.org/),
[Bioconductor](https://www.bioconductor.org/), the
[r-universe](https://r-universe.dev/search/) or e.g. as 
[github repositories](https://github.com/).

To access a package's functionality, you first have to add it to your system's
library. Afterward, you can check it out for use in your current session with
the `library()` command.
