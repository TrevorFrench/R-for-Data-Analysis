...
> "There is synthesis when, in combining therein judgments that are made known to us from simpler relations, one deduces judgments from them relative to more complicated relations. There is analysis when from a complicated truth one deduces more simple truths."  <br><br> -André-Marie Ampère
...
<!-- While I have specialized in analytics techniques through my M.S. in Data Analytics, B.S. in Business Analytics, and now my career as an Analytics Manager- I don't believe that specialization is required to begin using these techniques. -->
