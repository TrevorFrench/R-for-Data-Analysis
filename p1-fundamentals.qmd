...
- **Getting Familiar with R Studio**- There are four sections in R Studio. These sections are often referred to as "panes". This chapter will introduce you to the "source" pane, "console" pane, "environment" pane, and "files" pane. Additionally, you will learn about the different ways you can customize your version of R Studio.
